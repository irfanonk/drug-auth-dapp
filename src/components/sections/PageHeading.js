...
const PageHeading = ({ mobile }) => (
  <Container>
    <Header
      as="h1"
      content="Neon Template"
      className="main-title"
      style={{
        fontSize: mobile ? "1.5em" : "2.8em",
    ...
    <Header
      as="h2"
      content="Pages made with semantic-ui and Reactjs."
      style={{ fontSize: mobile ? "1.5em" : "1.3em" }}
    />

    {/* <Image src= {Background} style={{ width:'100%', height: '70%', maxHeight : '50rem'}} /> */}

    <Header as="h3" style={{ fontSize: mobile ? "1.2em" : "1.5em" }}>
      Hong Kong Neon Road
    </Header>

    <p>
      Mood Colors & photography inspirations. Quo cognito Constantius ultra
      ...
      omnes de industria milites agentes in civitatibus perviis.{" "}
    </p>
